...
{
    class ExcluirTipoStatusCommand : Notifiable<Notification>, ICommand
    {

        public ExcluirTipoStatusCommand()
        {

        }


        public ExcluirTipoStatusCommand(Guid idUsuario, EnTiposStatus nomeTipoStatus)
        {
            IdUsuario = idUsuario;
