...
{
    public class AlterarMomentoEmpresaCommand : Notifiable<Notification>, ICommand
    {

        public AlterarMomentoEmpresaCommand()
        {

        }

        public AlterarMomentoEmpresaCommand(EnTipoMomentoEmpresa nomeTipoMomentoCliente, Guid idUsuario)
        {
