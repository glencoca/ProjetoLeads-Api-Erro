...
{
    class ListarMomentoEmpresaCommand : Notifiable<Notification>, ICommand
    {

        public ListarMomentoEmpresaCommand()
        {

        }

        public ListarMomentoEmpresaCommand(EnTipoMomentoEmpresa nomeTipoMomentoCliente, Guid idUsuario)
        {
