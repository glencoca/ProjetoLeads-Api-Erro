...
{
    public class CriarMomentoEmpresaCommand : Notifiable<Notification>, ICommand
    {

        public CriarMomentoEmpresaCommand()
        {

        }

        public CriarMomentoEmpresaCommand(EnTipoMomentoEmpresa nomeTipoMomentoCliente, Guid idUsuario)
        {
