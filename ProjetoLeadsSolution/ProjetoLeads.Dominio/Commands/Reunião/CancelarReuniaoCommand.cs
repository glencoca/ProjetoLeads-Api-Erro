...
{
    public class CancelarReuniaoCommand : Notifiable<Notification>, ICommand
    {

        public CancelarReuniaoCommand()
        {

        }

        public CancelarReuniaoCommand(Guid idUsuario, Guid idReuniao)
        {
            IdUsuario = idUsuario;
            IdReuniao = idReuniao;
        }
